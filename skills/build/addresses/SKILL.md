...
Read [references/lending-and-staking.md](references/lending-and-staking.md) before writing Aave V3, Compound V3 Comet, Lido (stETH/wstETH/withdrawal queue), Rocket Pool, sDAI, or EigenLayer integrations.
...
| Contract | Address |
|----------|---------|
| stETH / Lido (deposit ETH here) | `0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84` |
| Withdrawal Queue (unstETH NFT) | `0x889edC2eDab5f40e902b864aD4d7AdE8E412F9B1` |

### Rocket Pool
| Contract | Address |
|----------|---------|
| rETH Token | `0xae78736Cd615f374D3085123A210448E74Fc6393` |
| Deposit Pool v1.1 | `0x2cac916b2A963Bf162f076C0a8a4a8200BCFBfb4` |
...
Read [references/uniswap-cookbook.md](references/uniswap-cookbook.md) before writing V2/V3/V4/Universal Router or Permit2 code — it covers swap surfaces, EIP-712 quirks, and command encoding.
...
| Contract | Address |
|----------|---------|
| DAI Savings Rate (Pot) | `0x197E90f9FAD81970bA7976f33CbD77088E5D7cf7` |
| sDAI (Savings Dai ERC-4626) | `0x83F20F44975D03b1b09e64809B757c47f942BEeA` |
...
Read [references/safe-and-aa.md](references/safe-and-aa.md) before deploying a Safe, signing `execTransaction`, packing MultiSend, building ERC-4337 v0.7 UserOps, or signing EIP-7702 authorizations.

### Safe (Gnosis Safe)
| Contract | Address |
|----------|---------|
| Singleton 1.3.0 | `0xd9Db270c1B5E3Bd161E8c8503c55cEABeE709552` |
...
Read [references/oracles-and-bridges.md](references/oracles-and-bridges.md) before reading Chainlink price feeds (with mandatory L2 sequencer-uptime gating), sending CCIP messages, or depositing through Across SpokePool.
...
| Contract | Address |
|----------|---------|
| VaultFactory 3.0.4 | `0x770D0d1Fb036483Ed4AbB6d53c1C88fb277D812F` |
...
| Contract | Address |
|----------|---------|
| Arachnid's Deployer | `0x4e59b44847b379578588920cA78FbF26c0B4956C` |
...
| Contract | Address |
|----------|---------|
| VELO Token (V2) | `0x9560e827aF36c94D2Ac33a39bCE1Fe78631088Db` |
...
| Exchange Router (latest) | `0x1C3fa76e6E1088bCE750f23a5BFcffa1efEF6A41` |
| Exchange Router (previous) | `0x7C68C7866A64FA2160F78EeAe12217FFbf871fa8` |
...
| Yield Contract Factory V3 | `0xEb38531db128EcA928aea1B1CE9E5609B15ba146` |
...
| Router (AMM V2) | `0xc873fEcbd354f5A56E00E710B90EF4201db2448d` |
| Factory (AMM V2) | `0x6EcCab422D763aC031210895C81787E87B43A652` |
| SwapRouter (AMM V4 / Algebra) | `0x4ee15342d6Deb297c3A2aA7CFFd451f788675F53` |
| AlgebraFactory (AMM V4) | `0xBefC4b405041c5833f53412fF997ed2f697a2f37` |
...
| Contract | Address |
|----------|---------|
| Router V1 | `0x2da10A1e27bF85cEdD8FFb1AbBe97e53391C0295` |
| Router V2 | `0x9B5def958d0f3b6955cBEa4D5B7809b2fb26b059` |
| Router V3 | `0x1B887a14216Bdeb7F8204Ee6a269Bd9Ff73A084C` |
| Classic Pool Factory V1 | `0xf2DAd89f2788a8CD54625C60b55cD3d2D0ACa7Cb` |
| Classic Pool Factory V2 | `0x0a34FBDf37C246C0B401da5f00ABd6529d906193` |
| Stable Pool Factory V1 | `0x5b9f21d407F35b10CbfDDca17D5D84b129356ea3` |
| Vault V1 | `0x621425a1Ef6abE91058E9712575dcc4258F8d091` |
...
|----------|---------|-------|--------|
| Morpho | `0xBBBBBbbBBb9cC5e90e3b3Af64bdAF62C37EEFFCb` | Base | Live |
